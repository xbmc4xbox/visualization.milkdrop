...
#define PRESETS_DIR "zip://special%3A%2F%2Fhome%2Faddons%2Fvisualization.milkdrop%2Fpresets%2F"
...
extern "C" ADDON_STATUS ADDON_Create(void* hdl, void* props)
{
  ...
  Preinit();
  if(!g_plugin || !g_plugin->PluginInitialize((LPDIRECT3DDEVICE8)visprops->device, visprops->x, visprops->y, visprops->width, visprops->height, visprops->pixelRatio))
    return ADDON_STATUS_UNKNOWN;
